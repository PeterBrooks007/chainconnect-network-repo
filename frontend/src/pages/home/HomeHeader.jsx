...
import LogoImg2 from "./../../assets/favicon_logo.png";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link component={RouterLink} to="/"  sx={{display: {xs:"none", md: "flex"}}}>
            <img
              src={LogoImg2}
              alt="logo"
              width="40px"
          ...
          <Link component={RouterLink} to="/" sx={{display: {xs:"flex", md: "none"}}}>
            <img
              src={LogoImg}
              alt="logo"
              width="150px"
