          ...
          <CardActionArea disableRipple>
            ...
            <CardContent>
              ...
              >
                <TextField
                  value={
                    "http://Vortexexperts.live/auth/register"
                  }
            ...
            >
                <Button
                  ...
                  color="secondary"
                  onClick={() =>
                    handleCopyReferralLinkMobile("http://Vortexexperts.live/auth/register")
                  }
                >
                  Copy Link
                </Button>
        ...
        >
          ...
          <Stack direction={"row"} spacing={1} display={{xs: "none", md: "flex"}}>
            ...
            <Button
              ...
              color="secondary"
              onClick={() =>
                handleCopyReferralLink("http://Vortexexperts.live/auth/register")
              }
            >
              Copy Link
            </Button>
          ...
          {/* <Typography variant="subtitle2">
            http://Vortexexperts.live/register
          </Typography> */}
        </Stack>
      </Stack>
