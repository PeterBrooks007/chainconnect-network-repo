...
import StakingModal from "../../components/drawers/StakingModal";
...
const WalletSidebar = ({ Skeletonloader, isScrolling }) => {
  ...
  const [openStakingMenu, setOpenStakingMenu] = useState(false);

  const handleOpenStakingMenu = () => {
    setOpenStakingMenu(true);
    document.documentElement.style.overflow = "hidden"; // Disables scroll on <html>
  };

  const handleCloseStakingMenu = () => {
    setOpenStakingMenu(false);
    document.documentElement.style.overflow = ""; // Resets <html> scroll
  };
  ...
  return (
    <>
      ...
      <StakingModal
        ...
        handleClose={handleCloseStakingMenu}
        handleOpen={handleOpenStakingMenu}
      />
