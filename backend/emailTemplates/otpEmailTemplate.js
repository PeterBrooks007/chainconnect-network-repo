const otpEmailTemplate = (name, otp) => {
    const email = {
        body: {
            name,
            intro: 'Welcome to vortexexperts trading platform! We\'re very excited to have you on board. <br><br> To enhance the security of your account, we kindly request you to complete the email verification process. This simple step not only safeguards your account against unauthorized access but also ensures you receive critical notifications regarding your trades and account activities',
            action: {
